...
@MEDIA_TWEAKS =
(
	[ [ 'CMC MAG',  'R01', 0x00 ], [                         ], [ 0b00000110 ], sub { $_[0] >= 0x011 && $_[0] < 0x020 } ],
	[ [ 'CMC MAG',  'R01', 0x00 ], [                         ], [ 0b00011110 ], sub { $_[0] >= 0x021 && $_[0] < 0x030 } ],
	[ [ 'CMC MAG',  'R01', 0x00 ], [ 'CMC MAG',  'M01', 0x00 ], [            ], sub { $_[0] >= 0x031 && $_[0] < 0x040 } ],
	[ [ 'MCC',      '002', 0x00 ], [                         ], [ 0b00011110 ], sub { $_[0] >= 0x021 && $_[0] < 0x030 } ],
	[ [ 'MCC',      '002', 0x00 ], [ 'MCC',      '003', 0x00 ], [            ], sub { $_[0] >= 0x031 && $_[0] < 0x040 } ],
	[ [ 'OPTODISC', 'OR4', 0x00 ], [ 'PRODISC',  'R03', 0x00 ], [            ], sub { $_[0] >= 0x021 && $_[0] < 0x040 } ],
	[ [ 'OPTODISC', 'OR8', 0x00 ], [ 'RICOHJPN', 'R01', 0x02 ], [            ], sub { $_[0] >= 0x021 && $_[0] < 0x030 } ],
	[ [ 'PRODISC',  'R02', 0x00 ], [ 'PRODISC',  'R03', 0x00 ], [            ], sub { $_[0] >= 0x011 && $_[0] < 0x040 } ],
	[ [ 'RICOHJPN', 'R00', 0x00 ], [                         ], [ 0b00000110 ], sub { $_[0] >= 0x011 && $_[0] < 0x040 } ],
	[ [ 'RICOHJPN', 'R01', 0x02 ], [                         ], [ 0b00011110 ], sub { $_[0] >= 0x021 && $_[0] < 0x030 } ],
	...
	[ [ 'FUJIFILM03',      0x52 ], [ 'TYG02',           0x52 ], [            ], sub { $_[0] >= 0x021 && $_[0] < 0x030 } ],
	[ [ 'MCC 01RG20  ',    0x52 ], [ 'MCC 02RG20  ',    0x52 ], [            ], sub { $_[0] >= 0x021 && $_[0] < 0x030 } ],
	[ [ 'OPTODISCR004',    0x52 ], [ 'AML',             0x52 ], [            ], sub { $_[0] >= 0x021 && $_[0] < 0x030 } ],
	[ [ 'PRINCO',          0x52 ], [ 'PRINCO8X01',      0x52 ], [            ], sub { $_[0] >= 0x021 && $_[0] < 0x040 } ],
	[ [ 'ProdiscS03  ',    0x52 ], [ 'ProdiscS04  ',    0x52 ], [            ], sub { $_[0] >= 0x021 && $_[0] < 0x030 } ],
	[ [ 'RITEKG04',        0x52 ], [ 'RITEKG05',        0x52 ], [            ], sub { $_[0] >= 0x031 && $_[0] < 0x040 } ],
	[ [ 'RITEKG05',        0x52 ], [ 'RITEKG06',        0x52 ], [            ], sub { $_[0] >= 0x021 && $_[0] < 0x030 } ],
	[ [ 'TYG01',           0x52 ], [ 'TYG02',           0x52 ], [            ], sub { $_[0] >= 0x021 && $_[0] < 0x040 } ],
);
